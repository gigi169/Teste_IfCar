...
<html lang="pt-BR">
    ...
    <body>
        ...
        <script>
            ...
            const universidades =
                document.querySelectorAll(".university");

            universidades.forEach(function(universidade) {

                universidade.addEventListener("click", function() {

                    universidades.forEach(function(item) {
